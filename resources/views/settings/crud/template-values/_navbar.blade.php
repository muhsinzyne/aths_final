@php
$nav = array(
    array('title' => 'List Template Values', 'view' => 'settings/crud/template-values'),
    array('title' => 'Create Tempalate Values', 'view' => 'settings/crud/template-values/create'),
    array('title' => 'Edit Template Value', 'view' => 'settings/crud/template-values/{id}/edit', 'is_edit' => true),
);
@endphp
