...
<div class="card {{ $class }}">
    ...
    <div id="kt_account_profile_details" class="collapse show">
        <!--begin::Form-->
            ...
            {{ Form::model($user, ['route' => ['settings.profile'],'method' => 'PUT','id' => 'kt_account_profile_details_form','class' => 'form', 'enctype' => 'multipart/form-data' ]) }}
            @method('PUT')
            <!--begin::Card body-->
            <div class="card-body border-top p-9">
                ...
                <!--begin::Input group-->
                <div class="row mb-6">
                    {{ Form::label('full_namne', 'Full Name', ['class' => 'col-lg-4 col-form-label required fw-bold fs-6']) }}
                    <div class="col-lg-8">
                        <div class="row">
                            <div class="col-lg-6 fv-row">
                                {{ Form::text('first_name', null, ['class' => 'form-control form-control-lg form-control-solid mb-3 mb-lg-0','placeholder' => 'First Name','required']) }}
                            </div>
                            <div class="col-lg-6 fv-row">
                                {{ Form::text('last_name', null, ['class' => 'form-control form-control-lg form-control-solid mb-3 mb-lg-0','placeholder' => 'First Name','required']) }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!--begin::Input group-->
                <div class="row mb-6">
                    {!! Html::decode(Form::label('phone', 'Contact Phone <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Mobile Number should be active"></i>', ['class' => 'col-lg-4 col-form-label required fw-bold fs-6'])) !!}
                    <div class="col-lg-8 fv-row">
                        {{ Form::text('phone', $user->info->phone, ['class' => 'form-control form-control-lg form-control-solid mb-3 mb-lg-0','placeholder' => 'Phone Number','required']) }}
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                ...
                <div class="row mb-6">
                    ...
                    {!! Html::decode(Form::label('phone', 'Country <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Contry of Origin"></i>', ['class' => 'col-lg-4 col-form-label required fw-bold fs-6'])) !!}
